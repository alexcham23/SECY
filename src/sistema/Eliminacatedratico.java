 ...
 * @author james
 */
public class Eliminacatedratico extends javax.swing.JFrame {
String carga;
    /**
     * Creates new form CrearStudent
     */
    public Eliminacatedratico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Usuario Catedratico");
        setResizable(false);
  ...
  //      label2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eliminacatedratico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Eliminacatedratico().setVisible(true);
            }
        });
    }
